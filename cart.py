...
class DecisionTreeClassifier:
    ...
    def _gini(self, y):
        ...
        Gini impurity is defined as sigma p(1-p) over all classes, with p the frequency of a
        class within the node. Since sigma p = 1, this is equivalent to 1 - sigma p^2.
        """
        m = y.size
